  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-slate-100 dark:border-slate-700 overflow-hidden transition-all">
      ...
      {transactions.length > 5 && (
        <div className="px-6 py-3 bg-slate-50 dark:bg-gray-750 border-t border-slate-100 dark:border-slate-700 text-center">
          <button
            onClick={() => setShowAllTransactions(true)}
            className="text-sm text-orange-gradient font-medium"
          >
